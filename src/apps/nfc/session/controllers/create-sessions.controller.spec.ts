...
// custom items
import { CreateSessionsController } from './create-sessions.controller';
...
{
    let controller: CreateSessionsController;
    ...
    beforeEach(async () => 
    {
        ...
        controller  = module.get<CreateSessionsController>(CreateSessionsController);
    ...
    describe('main', () => 
    {
        test('CreateSessionsController should be defined', () => 
        {
