...
export class OrigenGetPartnersController
{
    constructor(
    ...
    @Get()
    @ApiOperation({ summary: 'Find partners according to query' })
    @ApiOkResponse({ description: 'The records has been found successfully.', type: [PartnerDto] })
