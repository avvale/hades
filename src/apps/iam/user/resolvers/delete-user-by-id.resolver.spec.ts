...
// custom items
import { DeleteUserByIdResolver } from './delete-user-by-id.resolver';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { users } from '@hades/iam/user/infrastructure/seeds/user.seed';

describe('DeleteUserByIdResolver', () => 
{
    let resolver: DeleteUserByIdResolver;
    ...
    beforeAll(async () => 
    {
        ...
        resolver    = module.get<DeleteUserByIdResolver>(DeleteUserByIdResolver);
        queryBus    = module.get<IQueryBus>(IQueryBus);
        commandBus  = module.get<ICommandBus>(ICommandBus);
    });

    test('DeleteUserByIdResolver should be defined', () => 
    {
