...
// custom items
import { PaginateClientsResolver } from './paginate-clients.resolver';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { clients } from '@hades/o-auth/client/infrastructure/seeds/client.seed';

describe('PaginateClientsResolver', () => 
{
    let resolver: PaginateClientsResolver;
    ...
    beforeAll(async () => 
    {
        ...
        resolver    = module.get<PaginateClientsResolver>(PaginateClientsResolver);
        queryBus    = module.get<IQueryBus>(IQueryBus);
        commandBus  = module.get<ICommandBus>(ICommandBus);
    });

    test('PaginateClientsResolver should be defined', () => 
    {
