...
// custom items
import { DeleteClientByIdController } from './delete-client-by-id.controller';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { clients } from '@hades/o-auth/client/infrastructure/seeds/client.seed';

describe('DeleteClientByIdController', () => 
{
    let controller: DeleteClientByIdController;
    ...
    beforeAll(async () => 
    {
        ...
        controller  = module.get<DeleteClientByIdController>(DeleteClientByIdController);
    ...
    describe('main', () => 
    {
        test('DeleteClientByIdController should be defined', () => 
        {
