...
// custom items
import { PaginateResourcesResolver } from './paginate-resources.resolver';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { resources } from '@hades/admin/resource/infrastructure/seeds/resource.seed';

describe('PaginateResourcesResolver', () => 
{
    let resolver: PaginateResourcesResolver;
    ...
    beforeAll(async () => 
    {
        ...
        resolver    = module.get<PaginateResourcesResolver>(PaginateResourcesResolver);
