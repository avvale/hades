...
{   
    ...
    @ApiProperty({
        ...
        example     : [{
            ...
            receiverParty: 'SAMPLE_FLOW_RECEIVER_PARTY',
            component: 'SAMPLE_FLOW_COMPONENT',
            receiverComponent: 'SAMPLE_FLOW_RECEIVER_COMPONENT',
			interfaceName: 'SAMPLE_FLOW_INTERFACE',
			interfaceNamespace: 'SAMPLE_FLOW_INTERFACE_NAMESPACE',
			iflowName: '',
            ...
            channels: [
                {
                    ...
                    riInterfaceName: 'SAMPLE_RI_INTERFACE_NAME',
                    riInterfaceNamespace: 'SAMPLE_RI_INTERFACE_NAMESPACE'
                }
            ]
        }]
    })
