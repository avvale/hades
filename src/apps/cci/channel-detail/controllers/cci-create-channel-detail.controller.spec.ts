...
// custom items
import { CciCreateChannelDetailController } from './cci-create-channel-detail.controller';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { channelsDetail } from '@hades/cci/channel-detail/infrastructure/seeds/channel-detail.seed';

describe('CciCreateChannelDetailController', () => 
{
    let controller: CciCreateChannelDetailController;
    ...
    beforeAll(async () => 
    {
        ...
        controller  = module.get<CciCreateChannelDetailController>(CciCreateChannelDetailController);
    ...
    describe('main', () => 
    {
        test('CciCreateChannelDetailController should be defined', () => 
        {
