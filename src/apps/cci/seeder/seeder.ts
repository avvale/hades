...
export class Seeder 
{
    main()
    {
        NestFactory.createApplicationContext(SeederModule).then(async appContext => {
            ...
            IamUtils.iamCommonSeed(commandBus, queryBus, boundedContexts, permissions)
    ...
    {
        await queryBus.ask(new FindAccountByIdQuery('948a5308-a49d-42dc-9ea3-7490e120000b'));
        ...
        await commandBus.dispatch(new UpdateAccountCommand(
            '948a5308-a49d-42dc-9ea3-7490e120000b', // administrator account
            undefined,
            undefined,
            undefined,
            undefined,
