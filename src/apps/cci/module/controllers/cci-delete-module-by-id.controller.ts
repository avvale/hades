...
export class CciDeleteModuleByIdController
{
    constructor(
    ...
    {
        const module = await this.queryBus.ask(new FindModuleByIdQuery(id, constraint, { timezone }));

        await this.commandBus.dispatch(new DeleteModuleByIdCommand(id, constraint, { timezone }));
