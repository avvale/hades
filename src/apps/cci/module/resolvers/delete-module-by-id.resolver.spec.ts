...
// custom items
import { DeleteModuleByIdResolver } from './delete-module-by-id.resolver';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { modules } from '@hades/cci/module/infrastructure/seeds/module.seed';

describe('DeleteModuleByIdResolver', () => 
{
    let resolver: DeleteModuleByIdResolver;
    ...
    beforeAll(async () => 
    {
        ...
        resolver    = module.get<DeleteModuleByIdResolver>(DeleteModuleByIdResolver);
        queryBus    = module.get<IQueryBus>(IQueryBus);
        commandBus  = module.get<ICommandBus>(ICommandBus);
    });

    test('DeleteModuleByIdResolver should be defined', () => 
    {
