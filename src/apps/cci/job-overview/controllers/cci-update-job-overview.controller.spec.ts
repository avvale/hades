...
// custom items
import { CciUpdateJobOverviewController } from './cci-update-job-overview.controller';
import { ICommandBus } from '@hades/shared/domain/bus/command-bus';
import { IQueryBus } from '@hades/shared/domain/bus/query-bus';
import { jobsOverview } from '@hades/cci/job-overview/infrastructure/seeds/job-overview.seed';

describe('CciUpdateJobOverviewController', () => 
{
    let controller: CciUpdateJobOverviewController;
    ...
    beforeAll(async () => 
    {
        ...
        controller  = module.get<CciUpdateJobOverviewController>(CciUpdateJobOverviewController);
    ...
    describe('main', () => 
    {
        test('CciUpdateJobOverviewController should be defined', () => 
        {
