...
// custom items
import { CciDeleteMessageDetailByIdResolver } from './cci-delete-message-detail-by-id.resolver';
...
describe('CciDeleteMessageDetailByIdResolver', () => 
{
    ...
    beforeAll(async () => 
    {
        ...
        resolver    = module.get<CciDeleteMessageDetailByIdResolver>(CciDeleteMessageDetailByIdResolver);
