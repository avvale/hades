...
import { DeleteMessageDetailByIdCommand } from '@hades/bplus-it-sappi/message-detail/application/delete/delete-message-detail-by-id.command';
...
export class DeleteMessageDetailByIdResolver
{
    ...
    @Mutation('bplusItSappiDeleteMessageDetailById')
