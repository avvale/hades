...
export interface IMutation {
    ...
    nfcCreateActions(payload: NfcCreateActionInput[]): boolean | Promise<boolean>;
    ...
    nfcCreateSessions(payload: NfcCreateSessionInput[]): boolean | Promise<boolean>;
    ...
    nfcCreateSummaries(payload: NfcCreateSummaryInput[]): boolean | Promise<boolean>;
    ...
    nfcCreateTags(payload: NfcCreateTagInput[]): boolean | Promise<boolean>;
