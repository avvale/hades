...
export class OAuthAccessToken extends AggregateRoot
{
    ...
    constructor(id?: AccessTokenId, clientId?: AccessTokenClientId, accountId?: AccessTokenAccountId, token?: AccessTokenToken, name?: AccessTokenName, isRevoked?: AccessTokenIsRevoked, expiresAt?: AccessTokenExpiresAt, createdAt?: AccessTokenCreatedAt, updatedAt?: AccessTokenUpdatedAt, deletedAt?: AccessTokenDeletedAt, refreshToken?: OAuthRefreshToken, client?: OAuthClient, )
    {
        super();
    ...
    static register (id: AccessTokenId, clientId: AccessTokenClientId, accountId: AccessTokenAccountId, token: AccessTokenToken, name: AccessTokenName, isRevoked: AccessTokenIsRevoked, expiresAt: AccessTokenExpiresAt, createdAt: AccessTokenCreatedAt, updatedAt: AccessTokenUpdatedAt, deletedAt: AccessTokenDeletedAt, refreshToken?: OAuthRefreshToken, client?: OAuthClient, ): OAuthAccessToken
    {
        return new OAuthAccessToken(id, clientId, accountId, token, name, isRevoked, expiresAt, createdAt, updatedAt, deletedAt, refreshToken, client, );
    }
