...
@Table({ modelName: 'admin_country_translation', freezeTableName: true, timestamps: false })
export class AdminCountryTranslationModel extends Model<AdminCountryTranslationModel>
{
    @Column({
        field: 'id',
        primaryKey: true,
