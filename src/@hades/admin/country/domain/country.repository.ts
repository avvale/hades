...
export abstract class ICountryRepository implements IRepository<AdminCountry>
{
    ...
    abstract create(country: AdminCountry): Promise<void>;

    // create a single or multiple records
    abstract insert(countries: AdminCountry[], options?: object): Promise<void>;
    ...
    // update record
    abstract update(country: AdminCountry, constraint?: QueryStatement, cQMetadata?: CQMetadata): Promise<void>;
