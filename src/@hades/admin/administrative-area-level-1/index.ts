...
// models
export { AdminAdministrativeAreaLevel1Model } from './infrastructure/sequelize/sequelize-administrative-area-level-1.model';
...
export const AdminAdministrativeAreaLevel1Handlers = [
    // commands
...
export const AdminAdministrativeAreaLevel1Services = [
