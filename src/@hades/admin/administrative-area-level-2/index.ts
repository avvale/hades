...
// models
export { AdminAdministrativeAreaLevel2Model } from './infrastructure/sequelize/sequelize-administrative-area-level-2.model';
...
export const AdminAdministrativeAreaLevel2Handlers = [
    // commands
...
export const AdminAdministrativeAreaLevel2Services = [
