...
export class AdminAdministrativeAreaLevel3 extends AggregateRoot
{
    ...
    static register (
        ...
        administrativeAreaLevel1?: AdminAdministrativeAreaLevel1,
        administrativeAreaLevel2?: AdminAdministrativeAreaLevel2,
    ): AdminAdministrativeAreaLevel3
    {
        return new AdminAdministrativeAreaLevel3(
            id,
            countryId,
    ...
    created(administrativeAreaLevel3: AdminAdministrativeAreaLevel3): void
    {
        this.apply(
    ...
    updated(administrativeAreaLevel3: AdminAdministrativeAreaLevel3): void
    {
        this.apply(
    ...
    deleted(administrativeAreaLevel3: AdminAdministrativeAreaLevel3): void
    {
        this.apply(
