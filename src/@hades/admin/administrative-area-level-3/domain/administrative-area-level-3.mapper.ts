...
export class AdministrativeAreaLevel3Mapper implements IMapper
{
     ...
     */
    mapModelToAggregate(administrativeAreaLevel3: ObjectLiteral, cQMetadata?: CQMetadata): AdminAdministrativeAreaLevel3
    {
     ...
     */
    mapModelsToAggregates(administrativeAreasLevel3: ObjectLiteral[], cQMetadata?: CQMetadata): AdminAdministrativeAreaLevel3[]
    {
     ...
     * @param administrativeAreaLevel3
     */
    mapAggregateToResponse(administrativeAreaLevel3: AdminAdministrativeAreaLevel3): AdministrativeAreaLevel3Response
    {
     ...
     * @param administrativeAreasLevel3
     */
    mapAggregatesToResponses(administrativeAreasLevel3: AdminAdministrativeAreaLevel3[]): AdministrativeAreaLevel3Response[]
    {
        if (!Array.isArray(administrativeAreasLevel3)) return;
    ...
    private makeAggregate(administrativeAreaLevel3: ObjectLiteral, cQMetadata?: CQMetadata): AdminAdministrativeAreaLevel3
    {
    ...
    private makeResponse(administrativeAreaLevel3: AdminAdministrativeAreaLevel3): AdministrativeAreaLevel3Response
    {
        if (!administrativeAreaLevel3) return;
