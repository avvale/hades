...
// models
export { AdminAdministrativeAreaLevel3Model } from './infrastructure/sequelize/sequelize-administrative-area-level-3.model';
...
export const AdminAdministrativeAreaLevel3Handlers = [
    // commands
...
export const AdminAdministrativeAreaLevel3Services = [
