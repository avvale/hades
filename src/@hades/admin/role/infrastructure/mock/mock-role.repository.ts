...
} from '@hades/admin/role/domain/value-objects';
...
export class MockRoleRepository implements IRoleRepository
{
    ...
    public collectionSource: AdminRole[];
    ...
    private createSourceMockData(): void
    {
        ...
        for (const itemCollection of <any[]>roles)
        {
            ...
            this.collectionSource.push(AdminRole.register(
    ...
    async paginate(queryStatements: QueryStatementInput[] = [], constraint: QueryStatementInput[] = []): Promise<Pagination<AdminRole>>
    {
        let offset  = 0;
    ...
    async create(role: AdminRole): Promise<void>
    {
    ...
    async insert(role: AdminRole[]): Promise<void>
    {
    }

    async find(queryStatements: QueryStatementInput[] = []): Promise<AdminRole> 
    {
    ...
    async findById(id: UuidValueObject): Promise<AdminRole>
    {
    ...
    async get(queryStatements: QueryStatementInput[] = []): Promise<AdminRole[]> 
    {
        return this.collectionSource;
    }

    async update(aggregate: AdminRole): Promise<void> 
    { 
