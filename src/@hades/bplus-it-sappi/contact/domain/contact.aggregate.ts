...
export class BplusItSappiContact extends AggregateRoot
{
    ...
    static register (id: ContactId,tenantId: ContactTenantId,systemId: ContactSystemId,systemName: ContactSystemName,roleId: ContactRoleId,roleName: ContactRoleName,name: ContactName,surname: ContactSurname,email: ContactEmail,mobile: ContactMobile,area: ContactArea,hasConsentEmail: ContactHasConsentEmail,hasConsentMobile: ContactHasConsentMobile,isActive: ContactIsActive,flowsId: ContactFlowsId,createdAt: ContactCreatedAt,updatedAt: ContactUpdatedAt,deletedAt: ContactDeletedAt,): BplusItSappiContact
    {
        return new BplusItSappiContact(id, tenantId, systemId, systemName, roleId, roleName, name, surname, email, mobile, area, hasConsentEmail, hasConsentMobile, isActive, flowsId, createdAt, updatedAt, deletedAt, );
    }
