...
import { InsertChannelsCommand } from './insert-channels.command';
import { InsertChannelsService } from './insert-channels.service';
import { 
    ChannelId, 
    ChannelTenantId, 
    ChannelSystemId, 
...
@CommandHandler(InsertChannelsCommand)
export class InsertChannelsCommandHandler implements ICommandHandler<InsertChannelsCommand>
{
    constructor(
        private readonly insertChannelsService: InsertChannelsService
    ) { }

    async execute(command: InsertChannelsCommand): Promise<void>
    {
        // call to use case and implements ValueObjects
        await this.insertChannelsService.main(
            command.channels
                .map(channel => { 
                    return {
