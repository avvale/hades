...
export class UpdateChannelCommandHandler implements ICommandHandler<UpdateChannelCommand>
{
    ...
    async execute(command: UpdateChannelCommand): Promise<void>
    {
        ...
        await this.updateChannelService.main(
            ...
            new ChannelFlowHash(command.flowHash, { undefinable: true }),
            ...
            new ChannelVersion(command.version, { undefinable: true }),
            new ChannelAdapterType(command.adapterType),
            new ChannelDirection(command.direction, { undefinable: true }),
            ...
            new ChannelAdapterStatus(command.adapterStatus, { undefinable: true }),
