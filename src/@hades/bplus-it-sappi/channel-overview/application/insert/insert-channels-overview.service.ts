...
export class InsertChannelsOverviewService
{
    ...
    ): Promise<void>
    {
        ...
        const entityChannelsOverview = channelsOverview.map(channelOverview => BplusItSappiChannelOverview.register(
            channelOverview.id,
        ...
        // insert
        await this.repository.insert(entityChannelsOverview);
