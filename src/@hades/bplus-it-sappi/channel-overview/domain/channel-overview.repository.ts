...
import { BplusItSappiChannelOverview } from './channel-overview.entity';
...
export abstract class IChannelOverviewRepository implements IRepository<BplusItSappiChannelOverview>
{
    ...
    // paginate records
    abstract async paginate(queryStatements: QueryStatementInput[], constraint: QueryStatementInput[]): Promise<Pagination<BplusItSappiChannelOverview>>;

    // create a single record
    abstract async create(channelOverview: BplusItSappiChannelOverview): Promise<void>;

    // create a single or multiple records
    abstract async insert(channelsOverview: BplusItSappiChannelOverview[]): Promise<void>;
