...
export abstract class StringValueObject implements ValueObject<string>
{
    ...
    {
        if (this.validationRules.nullable === false && value === null)                              throw new BadRequestException(`Value for ${this.validationRules.name} must be defined, can not be null or undefined`);
