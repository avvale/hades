    ...
    describe('main', () => 
    {
        ...
        test('should update a channel and emit event', async () => 
        {
            expect(await service.main(
                ...
                new ChannelFlowHash(channels[0].flowHash),
                new ChannelFlowParty(channels[0].flowParty),
                new ChannelFlowReceiverParty(channels[0].flowReceiverParty),
                new ChannelFlowComponent(channels[0].flowComponent),
                new ChannelFlowReceiverComponent(channels[0].flowReceiverComponent),
