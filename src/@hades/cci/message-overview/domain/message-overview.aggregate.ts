...
export class CciMessageOverview extends AggregateRoot
{
    ...
    created(messageOverview: CciMessageOverview): void
    {
        this.apply(
    ...
    updated(messageOverview: CciMessageOverview): void
    {
        this.apply(
    ...
    deleted(messageOverview: CciMessageOverview): void
    {
        this.apply(
