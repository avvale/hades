...
describe('job-detail', () =>
{
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailId property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionExecutedAt: '2021-05-23 04:13:48',
                executionMonitoringStartAt: '2021-05-23 02:37:34',
                executionMonitoringEndAt: '2021-05-23 16:57:45',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 15:01:34',
                endAt: '2021-05-23 13:27:20',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantId property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 10:32:27',
                executionMonitoringStartAt: '2021-05-23 13:36:00',
                executionMonitoringEndAt: '2021-05-23 20:56:00',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 23:35:15',
                endAt: '2021-05-23 15:43:16',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantCode property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionExecutedAt: '2021-05-24 00:17:28',
                executionMonitoringStartAt: '2021-05-23 00:54:11',
                executionMonitoringEndAt: '2021-05-23 22:39:11',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 03:31:36',
                endAt: '2021-05-23 18:31:58',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemId property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 20:21:01',
                executionMonitoringStartAt: '2021-05-23 04:32:45',
                executionMonitoringEndAt: '2021-05-23 19:31:20',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 13:40:35',
                endAt: '2021-05-23 13:46:41',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemName property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 00:35:12',
                executionMonitoringStartAt: '2021-05-23 21:01:53',
                executionMonitoringEndAt: '2021-05-23 23:44:01',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 11:34:34',
                endAt: '2021-05-23 12:11:28',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionId property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionId: null,
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 12:01:08',
                executionMonitoringStartAt: '2021-05-23 14:43:38',
                executionMonitoringEndAt: '2021-05-23 22:00:20',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 05:36:06',
                endAt: '2021-05-23 21:27:31',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionType property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: null,
                executionExecutedAt: '2021-05-23 10:10:49',
                executionMonitoringStartAt: '2021-05-23 13:37:12',
                executionMonitoringEndAt: '2021-05-23 06:50:01',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 16:30:21',
                endAt: '2021-05-23 09:47:45',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionExecutedAt property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionMonitoringStartAt: '2021-05-23 03:25:33',
                executionMonitoringEndAt: '2021-05-23 12:35:32',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 09:34:49',
                endAt: '2021-05-23 12:13:36',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringStartAt property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 21:02:36',
                executionMonitoringStartAt: null,
                executionMonitoringEndAt: '2021-05-23 01:07:56',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 11:14:46',
                endAt: '2021-05-23 19:57:15',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringEndAt property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 11:01:10',
                executionMonitoringStartAt: '2021-05-23 15:45:22',
                ...
                startAt: '2021-05-23 09:24:12',
                endAt: '2021-05-23 04:40:25',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStatus property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 10:56:11',
                executionMonitoringStartAt: '2021-05-23 20:37:27',
                executionMonitoringEndAt: '2021-05-23 08:05:50',
                status: null,
                ...
                startAt: '2021-05-23 22:19:11',
                endAt: '2021-05-23 05:52:06',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStartAt property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 04:45:32',
                executionMonitoringStartAt: '2021-05-23 03:48:19',
                executionMonitoringEndAt: '2021-05-23 19:02:22',
                status: 'COMPLETED',
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailEndAt property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 09:29:55',
                executionMonitoringStartAt: '2021-05-23 09:22:11',
                executionMonitoringEndAt: '2021-05-23 00:29:41',
                status: 'ERROR',
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailId property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 07:07:54',
                executionMonitoringStartAt: '2021-05-23 06:04:04',
                executionMonitoringEndAt: '2021-05-23 01:59:53',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 13:13:12',
                endAt: '2021-05-23 06:59:04',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantId property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 19:07:37',
                executionMonitoringStartAt: '2021-05-23 11:31:58',
                executionMonitoringEndAt: '2021-05-23 01:10:14',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 11:03:06',
                endAt: '2021-05-23 01:44:18',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantCode property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 03:00:44',
                executionMonitoringStartAt: '2021-05-23 13:55:07',
                executionMonitoringEndAt: '2021-05-23 02:23:05',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 06:56:56',
                endAt: '2021-05-23 11:52:28',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemId property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 04:34:53',
                executionMonitoringStartAt: '2021-05-23 14:11:17',
                executionMonitoringEndAt: '2021-05-23 01:29:54',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 05:14:06',
                endAt: '2021-05-23 04:02:52',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemName property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 08:22:55',
                executionMonitoringStartAt: '2021-05-23 13:59:50',
                executionMonitoringEndAt: '2021-05-23 10:43:14',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 13:47:59',
                endAt: '2021-05-23 13:44:09',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionId property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 16:44:26',
                executionMonitoringStartAt: '2021-05-23 21:10:58',
                executionMonitoringEndAt: '2021-05-23 22:33:53',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 06:27:53',
                endAt: '2021-05-23 12:44:02',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionType property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionExecutedAt: '2021-05-23 06:14:12',
                executionMonitoringStartAt: '2021-05-23 06:53:19',
                executionMonitoringEndAt: '2021-05-23 07:10:40',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 03:14:15',
                endAt: '2021-05-23 00:59:28',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionExecutedAt property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionMonitoringStartAt: '2021-05-23 14:10:44',
                executionMonitoringEndAt: '2021-05-23 14:22:06',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 20:01:46',
                endAt: '2021-05-23 10:15:09',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringStartAt property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 15:51:01',
                executionMonitoringEndAt: '2021-05-24 00:14:41',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 15:03:28',
                endAt: '2021-05-23 10:52:23',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringEndAt property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 22:25:04',
                executionMonitoringStartAt: '2021-05-23 01:20:10',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 00:34:09',
                endAt: '2021-05-23 23:28:30',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStatus property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 21:08:53',
                executionMonitoringStartAt: '2021-05-23 16:55:56',
                executionMonitoringEndAt: '2021-05-23 21:51:30',
                ...
                startAt: '2021-05-23 05:43:34',
                endAt: '2021-05-23 10:16:44',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStartAt property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-24 00:04:53',
                executionMonitoringStartAt: '2021-05-23 18:43:19',
                executionMonitoringEndAt: '2021-05-23 18:30:17',
                status: 'COMPLETED',
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailEndAt property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 14:03:09',
                executionMonitoringStartAt: '2021-05-23 19:31:58',
                executionMonitoringEndAt: '2021-05-23 06:30:20',
                status: 'COMPLETED',
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailId is not allowed, must be a length of 36`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 09:47:27',
                executionMonitoringStartAt: '2021-05-23 07:11:27',
                executionMonitoringEndAt: '2021-05-23 14:03:34',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 17:04:16',
                endAt: '2021-05-23 08:13:29',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantId is not allowed, must be a length of 36`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 17:12:24',
                executionMonitoringStartAt: '2021-05-23 22:19:18',
                executionMonitoringEndAt: '2021-05-23 15:00:27',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 08:59:51',
                endAt: '2021-05-23 17:07:17',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemId is not allowed, must be a length of 36`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 01:37:39',
                executionMonitoringStartAt: '2021-05-23 04:52:05',
                executionMonitoringEndAt: '2021-05-23 18:11:07',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 20:40:10',
                endAt: '2021-05-23 09:38:34',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionId is not allowed, must be a length of 36`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 10:01:25',
                executionMonitoringStartAt: '2021-05-23 07:58:27',
                executionMonitoringEndAt: '2021-05-23 04:46:15',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 04:04:05',
                endAt: '2021-05-23 03:00:48',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailTenantCode is too large, has a maximum length of 50`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 06:26:10',
                executionMonitoringStartAt: '2021-05-24 00:01:37',
                executionMonitoringEndAt: '2021-05-23 17:30:34',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 13:16:34',
                endAt: '2021-05-23 20:07:23',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailSystemName is too large, has a maximum length of 20`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 10:21:21',
                executionMonitoringStartAt: '2021-05-23 02:00:14',
                executionMonitoringEndAt: '2021-05-23 08:04:46',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 04:54:45',
                endAt: '2021-05-23 22:14:38',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailName is too large, has a maximum length of 255`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 11:36:33',
                executionMonitoringStartAt: '2021-05-23 04:37:55',
                executionMonitoringEndAt: '2021-05-23 19:52:19',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 09:00:41',
                endAt: '2021-05-23 20:25:14',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailReturnCode is too large, has a maximum length of 10`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 04:55:31',
                executionMonitoringStartAt: '2021-05-23 20:52:35',
                executionMonitoringEndAt: '2021-05-23 16:36:48',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 15:07:33',
                endAt: '2021-05-23 11:54:57',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailNode is too large, has a maximum length of 160`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 04:35:00',
                executionMonitoringStartAt: '2021-05-23 14:14:19',
                executionMonitoringEndAt: '2021-05-23 12:34:51',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 13:49:09',
                endAt: '2021-05-23 23:12:28',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailUser is too large, has a maximum length of 255`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 15:18:45',
                executionMonitoringStartAt: '2021-05-23 22:34:24',
                executionMonitoringEndAt: '2021-05-23 04:03:32',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 21:36:10',
                endAt: '2021-05-23 05:00:34',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailReturnCode has to be a integer value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 07:01:06',
                executionMonitoringStartAt: '2021-05-23 04:20:26',
                executionMonitoringEndAt: '2021-05-23 01:55:27',
                status: 'CANCELLED',
                ...
                startAt: '2021-05-23 05:20:05',
                endAt: '2021-05-23 22:57:36',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionType has to be a enum option of SUMMARY, DETAIL`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'XXXX',
                executionExecutedAt: '2021-05-23 04:51:10',
                executionMonitoringStartAt: '2021-05-23 07:27:03',
                executionMonitoringEndAt: '2021-05-23 17:58:35',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 11:43:21',
                endAt: '2021-05-23 02:05:59',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStatus has to be a enum option of CANCELLED, COMPLETED, ERROR`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 04:44:48',
                executionMonitoringStartAt: '2021-05-23 13:41:45',
                executionMonitoringEndAt: '2021-05-23 23:59:55',
                status: 'XXXX',
                ...
                startAt: '2021-05-23 14:20:52',
                endAt: '2021-05-23 02:54:43',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionExecutedAt has to be a timestamp value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionMonitoringStartAt: '2021-05-23 01:38:56',
                executionMonitoringEndAt: '2021-05-23 02:06:00',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 03:52:25',
                endAt: '2021-05-23 09:11:20',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringStartAt has to be a timestamp value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 11:32:42',
                executionMonitoringStartAt: 'XXXXXXXX',
                executionMonitoringEndAt: '2021-05-23 14:14:31',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 03:18:56',
                endAt: '2021-05-23 04:42:56',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailExecutionMonitoringEndAt has to be a timestamp value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 07:17:50',
                executionMonitoringStartAt: '2021-05-23 23:16:41',
                ...
                startAt: '2021-05-23 16:35:12',
                endAt: '2021-05-23 07:25:42',
            })
            .expect(400)
            .then(res => {
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailStartAt has to be a timestamp value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 22:45:03',
                executionMonitoringStartAt: '2021-05-23 19:08:58',
                executionMonitoringEndAt: '2021-05-23 05:15:26',
                status: 'ERROR',
    ...
    test(`/REST:POST cci/job-detail - Got 400 Conflict, JobDetailEndAt has to be a timestamp value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'SUMMARY',
                executionExecutedAt: '2021-05-23 17:19:57',
                executionMonitoringStartAt: '2021-05-23 22:17:35',
                executionMonitoringEndAt: '2021-05-23 18:01:01',
                status: 'CANCELLED',
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: '523e156a-bb2e-4ab8-8686-05bafb43a32b'
                    }
                }
            })
            .expect(404);
    ...
    test(`/REST:POST cci/job-detail`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-23 21:26:37',
                executionMonitoringStartAt: '2021-05-23 21:26:37',
                executionMonitoringEndAt: '2021-05-23 21:26:37',
                status: 'COMPLETED',
                ...
                startAt: '2021-05-23 21:26:37',
                endAt: '2021-05-23 21:26:37',
            })
            .expect(201);
    });
    ...
    {
        return request(app.getHttpServer())
            .get('/cci/job-detail/e11d5b41-b044-4cf4-ac00-0d607396d196')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    test(`/REST:PUT cci/job-detail - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                executionType: 'DETAIL',
                executionExecutedAt: '2021-05-24 00:04:33',
                executionMonitoringStartAt: '2021-05-23 02:34:17',
                executionMonitoringEndAt: '2021-05-23 17:47:18',
                status: 'ERROR',
                ...
                startAt: '2021-05-23 12:42:37',
                endAt: '2021-05-23 17:16:24',
            })
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/cci/job-detail/89dc3773-d51f-4b5d-9289-7602abbc6dd2')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: 'dbba480d-6608-4c23-aad0-16a3fc17e8c8'
                        }
                    }
                }
            })
    ...
    test(`/GraphQL cciFindJobDetailById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '7b22b9e9-3ecd-4093-b2e7-165d3db5d225'
                }
            })
            .expect(200)
            .then(res => {
    ...
    test(`/GraphQL cciDeleteJobDetailById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '36614b0d-dd03-4fc5-88c8-4696b357c6cb'
                }
            })
            .expect(200)
            .then(res => {
