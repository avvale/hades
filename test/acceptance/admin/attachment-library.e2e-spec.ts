...
describe('attachment-library', () =>
{
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: 'de62aec0-0488-4d0d-8150-31ab261f690f'
                    }
                }
            })
            .expect(404);
    ...
    {
        return request(app.getHttpServer())
            .get('/admin/attachment-library/5a3c36b0-64dc-4f26-a465-af94868d2c7f')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/admin/attachment-library/22e0cf4d-cd8b-438e-9505-8e888d40764b')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    test(`/GraphQL adminCreateAttachmentLibrary`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                variables: {
                    payload: {
                        id: '70be20ac-981f-42dd-ae84-5afeef4cfa7c',
                        ...
                        pathname: '',
                        filename: '94fbgxztxh6k371q8abl7airl312raizbook4zo6lhtvhi2i52vr5zwwfybzgvvsjcb22tydt5cmlhsfuq1g3az43iypz35lr19fq5xdcyamk0ucu88kcxjwbvq9q8ret96fqrjswnje4vs26k81996zf869z6auhukkabcjfyaqfpchcbzv8m47qme17w39lng0ial3n897ava9kygwz5bvh5a58mfwce584ww1s31cpd4284k4a62c2xt9vor',
                        url: '',
                        mime: '41yuxarbxog66bxf6rzih1co0zrwmjkki9n0xafrh2tts2ar26',
                        extension: 'nvhfkoolce3bf4nexrel1vcoekekzvv1jjhs9u4hfsdddm8a39',
                        size: 6907805625,
                        width: 179884,
                        height: 921967,
                        data: {"foo":"br3vz<fHGR","bar":17607,"bike":68217,"a":17228,"b":55993,"name":"n[+OZUA$hv","prop":"]>:oDZ?\"#,"},
                    }
                }
            })
            .expect(200)
            .then(res => {
                expect(res.body.data.adminCreateAttachmentLibrary).toHaveProperty('id', '70be20ac-981f-42dd-ae84-5afeef4cfa7c');
            });
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: '8519cca2-22c3-43e5-a456-c1a64cbe7ee1'
                        }
                    }
                }
            })
    ...
    test(`/GraphQL adminFindAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '3be3d201-a9eb-4881-b7e2-f7bd9798bfa3'
                }
            })
            .expect(200)
            .then(res => {
    ...
    test(`/GraphQL adminDeleteAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: 'f85cb088-739e-46ac-a45e-905cf36033cd'
                }
            })
            .expect(200)
            .then(res => {
