...
describe('attachment-library', () =>
{
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: '77f34512-6d34-488e-9219-db4ae247106e'
                    }
                }
            })
            .expect(404);
    ...
    {
        return request(app.getHttpServer())
            .get('/admin/attachment-library/089e4de7-63a9-48b5-947c-7a76d04f0f5b')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/admin/attachment-library/6802df99-ed38-4e4f-aa4e-6f043d232cc1')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: '2b952376-108f-4f54-8ae6-d32d9cf42295'
                        }
                    }
                }
            })
    ...
    test(`/GraphQL adminFindAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '1a78b930-5e29-4370-aba7-e45e314fab9f'
                }
            })
            .expect(200)
            .then(res => {
    ...
    test(`/GraphQL adminDeleteAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '47603ea6-4672-43d3-97c7-ef3df505b2a5'
                }
            })
            .expect(200)
            .then(res => {
