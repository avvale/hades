...
describe('attachment-library', () =>
{
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: '049f01d3-e57e-4326-9217-4ca6ec1c95ca'
                    }
                }
            })
            .expect(404);
    ...
    {
        return request(app.getHttpServer())
            .get('/admin/attachment-library/0d64dd11-1e6b-4249-88d3-9eb0f245f60f')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/admin/attachment-library/abf1057e-32f0-4157-b217-491e591e5458')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: 'a0d0067d-322a-4087-841e-5172ca71d28b'
                        }
                    }
                }
            })
    ...
    test(`/GraphQL adminFindAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: 'ae765b54-3f05-4689-ae5e-c349b4aecd38'
                }
            })
            .expect(200)
            .then(res => {
    ...
    test(`/GraphQL adminDeleteAttachmentLibraryById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: 'b5584e74-3837-44c7-bb4e-3349ff15a294'
                }
            })
            .expect(200)
            .then(res => {
