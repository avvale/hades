...
describe('client', () =>
{
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientId property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 2257991891,
                expiredRefreshToken: 8476107971,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientGrantType property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 4062143521,
                expiredRefreshToken: 4256458025,
                isActive: false,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientName property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 7617678874,
                expiredRefreshToken: 4253071601,
                isActive: true,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientSecret property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 8875806806,
                expiredRefreshToken: 5505086956,
                isActive: false,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsActive property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 4224264749,
                expiredRefreshToken: 8425029501,
                isActive: null,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsMaster property can not to be null`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 5018676443,
                expiredRefreshToken: 3332840823,
                isActive: false,
                isMaster: null,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientId property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 1757124140,
                expiredRefreshToken: 5645022910,
                isActive: false,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientGrantType property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 2805728164,
                expiredRefreshToken: 1907969253,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientName property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 6792529048,
                expiredRefreshToken: 2643716850,
                isActive: true,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientSecret property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 7983698713,
                expiredRefreshToken: 7374772313,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsActive property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 7679010065,
                expiredRefreshToken: 8134838273,
                isMaster: true,
                applicationIds: [],
            })
            .expect(400)
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsMaster property can not to be undefined`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 4148851774,
                expiredRefreshToken: 7370418399,
                isActive: false,
                applicationIds: [],
            })
            .expect(400)
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientId is not allowed, must be a length of 36`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 6407333282,
                expiredRefreshToken: 1955631836,
                isActive: false,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientName is too large, has a maximum length of 255`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 7977243286,
                expiredRefreshToken: 7764247620,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientSecret is too large, has a maximum length of 90`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 4805052007,
                expiredRefreshToken: 9757979246,
                isActive: false,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientAuthUrl is too large, has a maximum length of 2048`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 3212406887,
                expiredRefreshToken: 9026971432,
                isActive: false,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientRedirect is too large, has a maximum length of 2048`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 9904188310,
                expiredRefreshToken: 5120350702,
                isActive: false,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientExpiredAccessToken is too large, has a maximum length of 10`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 38922901773,
                expiredRefreshToken: 3429864594,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientExpiredRefreshToken is too large, has a maximum length of 10`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 5810152024,
                expiredRefreshToken: 24153011739,
                isActive: false,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientExpiredAccessToken must have a positive sign`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredRefreshToken: 3223750660,
                isActive: true,
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsActive has to be a boolean value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 8112246896,
                expiredRefreshToken: 1200415889,
                isActive: 'true',
                isMaster: false,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientIsMaster has to be a boolean value`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 4870737509,
                expiredRefreshToken: 2225459885,
                isActive: false,
                isMaster: 'true',
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client - Got 400 Conflict, ClientGrantType has to be a enum option of AUTHORIZATION_CODE, CLIENT_CREDENTIALS, PASSWORD`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 8214213677,
                expiredRefreshToken: 9909484106,
                isActive: true,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:POST o-auth/client`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 3893571113,
                expiredRefreshToken: 9720743301,
                isActive: false,
                isMaster: false,
                applicationIds: [],
            })
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: '0c3c64b9-571a-4013-a8ad-c6b0966ceb5f'
                    }
                }
            })
            .expect(404);
    ...
    {
        return request(app.getHttpServer())
            .get('/o-auth/client/20a551ec-ad71-4864-a203-72a2708f9f82')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    test(`/REST:PUT o-auth/client - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                expiredAccessToken: 8107401250,
                expiredRefreshToken: 7708462887,
                isActive: true,
                isMaster: true,
                applicationIds: [],
            })
    ...
    test(`/REST:PUT o-auth/client`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                authUrl: '',
                redirect: '',
                expiredAccessToken: 7826230741,
                expiredRefreshToken: 4825130824,
                isActive: false,
                isMaster: false,
                applicationIds: [],
            })
    ...
    {
        return request(app.getHttpServer())
            .delete('/o-auth/client/b740209c-9bba-4905-bb13-d474a0ac8a15')
            .set('Accept', 'application/json')
            .set('Authorization', `Bearer ${testJwt}`)
            .expect(404);
    });
    ...
    test(`/GraphQL oAuthCreateClient`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                variables: {
                    payload: {
                        id: '9701781c-6551-4243-a61c-a0e8dd04c3eb',
                        grantType: 'PASSWORD',
                        ...
                        secret: 'cdyrl1forbodwozlqpexzxjgkmv10g43tgjhehkgt8ou5lht4kje3qnln97hwu74thggz0hre9zemrbkpahus3nq90',
                        authUrl: '',
                        redirect: '',
                        expiredAccessToken: 7095463626,
                        expiredRefreshToken: 4674220767,
                        isActive: true,
                        isMaster: true,
                        applicationIds: [],
                    }
            ...
            .expect(200)
            .then(res => {
                expect(res.body.data.oAuthCreateClient).toHaveProperty('id', '9701781c-6551-4243-a61c-a0e8dd04c3eb');
            });
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: '6eec75f5-e3b0-44fa-a96b-9538d2bfbab6'
                        }
                    }
                }
            })
    ...
    test(`/GraphQL oAuthFindClientById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: 'ceac6997-a7cc-44c2-ab14-d0715ca3d55d'
                }
            })
            .expect(200)
            .then(res => {
            ...
            .send({
                ...
                variables: {
                    payload: {
                        ...
                        authUrl: '',
                        redirect: '',
                        expiredAccessToken: 5208486998,
                        expiredRefreshToken: 7547858026,
                        isActive: true,
                        isMaster: true,
                        applicationIds: [],
                    }
            ...
            .send({
                ...
                variables: {
                    payload: {
                        ...
                        authUrl: '',
                        redirect: '',
                        expiredAccessToken: 1823106400,
                        expiredRefreshToken: 9931596297,
                        isActive: false,
                        isMaster: false,
                        applicationIds: [],
                    }
    ...
    test(`/GraphQL oAuthDeleteClientById - Got 404 Not Found`, () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '21474905-dec1-4a06-998a-895dff87f215'
                }
            })
            .expect(200)
            .then(res => {
